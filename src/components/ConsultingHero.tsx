    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-2 mb-4 animate-fade-in-delay-1">
          ...
          <span className="text-xs font-mono text-muted-foreground">disponível para novos projetos</span>
        </div>
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground mb-10 animate-fade-in-delay-2">
          {t("subtitle")}
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 animate-fade-in-delay-3">
          {(
            ...
            return (
              ...
              >
                <Icon className="w-5 h-5 text-v4-red mb-3 mx-auto" />
        ...
        <a
          href="#lead-capture"
          className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-v4-red text-background font-semibold text-lg hover:bg-v4-red/90 transition-all duration-300 animate-fade-in-delay-3 group"
        >
          {t("cta")}
