    ...
    <section className="relative px-4 py-24 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {items.map((item, i) => {
          ...
          return (
            <div key={i} className="gradient-border rounded-xl p-6 md:p-8 bg-card animate-fade-in" style={{ animationDelay: `${i * 150}ms` }}>
              <div className="flex items-start gap-4">
                <div className="shrink-0 w-12 h-12 rounded-xl bg-card-hover flex items-center justify-center">
