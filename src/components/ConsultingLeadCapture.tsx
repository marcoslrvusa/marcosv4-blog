      ...
      <div className="gradient-border rounded-xl p-6 md:p-8 bg-[#0c0c18]">
        {status === "success" ? (
          <div className="text-center py-8">
            ...
            <p className="text-lg font-semibold text-[#00ff88]">{message}</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" required value={formData.name} onChange={e => handleChange("name", e.target.value)}
                placeholder="Seu nome" className="w-full rounded-lg border border-[#1a1a2e] bg-[#050508] px-4 py-3 text-sm text-[#e8e8f0] placeholder:text-[#6b6b80] focus:border-[#00ff88]/50 focus:outline-none focus:ring-1 focus:ring-[#00ff88]/20" />
            </div>
            <div>
              <label className="block text-xs font-mono text-[#6b6b80] uppercase tracking-wider mb-1.5">
              ...
              <input type="email" required value={formData.email} onChange={e => handleChange("email", e.target.value)}
                placeholder="seu@email.com" className="w-full rounded-lg border border-[#1a1a2e] bg-[#050508] px-4 py-3 text-sm text-[#e8e8f0] placeholder:text-[#6b6b80] focus:border-[#00ff88]/50 focus:outline-none focus:ring-1 focus:ring-[#00ff88]/20" />
            </div>
            <div>
              <label className="block text-xs font-mono text-[#6b6b80] uppercase tracking-wider mb-1.5">
              ...
              <input type="text" value={formData.company} onChange={e => handleChange("company", e.target.value)}
                placeholder="Sua empresa (opcional)" className="w-full rounded-lg border border-[#1a1a2e] bg-[#050508] px-4 py-3 text-sm text-[#e8e8f0] placeholder:text-[#6b6b80] focus:border-[#00ff88]/50 focus:outline-none focus:ring-1 focus:ring-[#00ff88]/20" />
            </div>
            <div>
              <label className="block text-xs font-mono text-[#6b6b80] uppercase tracking-wider mb-1.5">
              ...
              <textarea rows={3} value={formData.pain} onChange={e => handleChange("pain", e.target.value)}
                placeholder="Conte um pouco sobre o que sua empresa precisa..." className="w-full rounded-lg border border-[#1a1a2e] bg-[#050508] px-4 py-3 text-sm text-[#e8e8f0] placeholder:text-[#6b6b80] focus:border-[#00ff88]/50 focus:outline-none focus:ring-1 focus:ring-[#00ff88]/20" />
            </div>
            <button type="submit" disabled={status === "loading"}
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#00ff88] px-6 py-4 text-base font-semibold text-[#050508] transition-all hover:bg-[#00ff88]/90 disabled:opacity-60">
