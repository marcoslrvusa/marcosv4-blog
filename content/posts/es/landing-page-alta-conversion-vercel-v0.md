...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Landing page de alta conversión con Vercel + v0",
  "description": "Aumenta conversiones con estructura de call‑to‑action optimizada y componentes v0.",
...
## Como montar um landing page de alta conversión con vercel + v0
