...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + OpenAI API + v0: Demostración de chat",
  "description": "Crea un chatbot IA usando Next.js API routes y OpenAI con Vercel + v0.",
...
## Como montar um vercel + openai api + v0
