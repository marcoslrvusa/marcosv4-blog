...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + Docker (experimental) con v0",
  "description": "Usar Vercel Runtime con Docker y containers Edge para cargas pesadas.",
...
## Como montar um vercel + docker (experimental) con v0
