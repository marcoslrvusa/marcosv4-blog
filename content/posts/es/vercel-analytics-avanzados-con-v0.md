...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel Analytics avanzados con v0",
  "description": "Analizar automáticamente métricas LCP, FID & CLS con Vercel Analytics (built‑in).",
...
## Como montar um vercel analytics avanzados con v0
