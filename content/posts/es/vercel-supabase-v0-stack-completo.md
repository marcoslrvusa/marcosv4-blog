...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + Supabase + v0: Stack completo",
  "description": "Monta un stack full‑stack Jamstack con Vercel, Supabase y v0 para IA.",
...
## Como montar um vercel + supabase + v0
