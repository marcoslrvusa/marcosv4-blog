...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + OpenAI Whisper + v0: Transcripción en tiempo real",
  "description": "Transcribe audios usando Whisper API en Edge Functions.",
...
## Como montar um vercel + openai whisper + v0
