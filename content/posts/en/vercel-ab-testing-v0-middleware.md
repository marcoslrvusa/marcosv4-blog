...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + A/B Testing with v0 and Middleware",
  "description": "Run experiments in production without complex setup.",
...
## Como montar um vercel + a/b testing with v0 and middleware
