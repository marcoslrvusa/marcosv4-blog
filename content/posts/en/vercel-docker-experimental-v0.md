...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + Docker (experimental) with v0",
  "description": "Use Vercel Runtime with Docker & Edge containers for heavy workloads.",
...
## Como montar um vercel + docker (experimental) with v0
