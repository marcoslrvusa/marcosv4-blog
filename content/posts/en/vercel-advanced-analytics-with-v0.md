...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel Advanced Analytics with v0",
  "description": "Automatically analyze LCP, FID & CLS metrics with Vercel Analytics (built‑in).",
...
## Como montar um vercel advanced analytics with v0
