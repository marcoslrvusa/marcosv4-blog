...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Static Apps Deploy optimised with Vercel + v0",
  "description": "Structure for Svelte, Astro, Hugo, etc.",
...
## Como montar um static apps deploy optimised with vercel + v0
