...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + Docker (experimental) com v0",
  "description": "Usar Vercel Runtime com Docker e containers edge para cargas pesadas.",
...
## Como montar um vercel + docker (experimental) com v0
