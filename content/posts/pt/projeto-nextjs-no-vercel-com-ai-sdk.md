...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Projeto Next.js no Vercel com AI SDK",
  "description": "Crie um app AI‑powered usando Next.js, AI SDK da Vercel e OpenAI.",
...
## Como montar um projeto next.js no vercel com ai sdk
