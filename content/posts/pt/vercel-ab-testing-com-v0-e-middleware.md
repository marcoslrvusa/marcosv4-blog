...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + A/B Testing com v0 e Middleware",
  "description": "Faça experimentos em produção sem configuração complexa.",
...
## Como montar um vercel + a/b testing com v0 e middleware
