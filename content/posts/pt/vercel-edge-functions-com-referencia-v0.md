...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel Edge Functions com referência v0",
  "description": "Exemplos práticos de Edge Functions para IA On‑Edge usando v0.",
...
## Como montar um vercel edge functions com referência v0
