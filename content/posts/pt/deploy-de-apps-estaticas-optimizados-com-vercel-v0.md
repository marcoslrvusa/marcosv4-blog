...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Deploy de apps estáticas optimizados com Vercel + v0",
  "description": "Estrutura para Svelte, Astro, Hugo, etc.",
...
## Como montar um deploy de apps estáticas optimizados com vercel + v0
