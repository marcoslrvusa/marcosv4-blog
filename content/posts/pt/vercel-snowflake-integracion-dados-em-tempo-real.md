...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Vercel + Snowflake: integração de dados em tempo real",
  "description": "Como conectar Vercel Edge Functions ao Snowflake para criar dashboards em tempo real com baixa latência.",
...
## Como montar um vercel + snowflake
